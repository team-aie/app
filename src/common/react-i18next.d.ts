// Because this is for fixing the type definition of react-i18next.
/* eslint-disable @typescript-eslint/no-explicit-any,no-var,@typescript-eslint/ban-types */

/**
 * This file is needed to temporarily solve compilation errors for `react-i18next`.
 *
 * TODO: Remove this file after their type declarations are fixed.
 * See also: https://github.com/microsoft/TypeScript/issues/17042#issuecomment-327882577.
 */

import i18next, { ReactOptions, Resource, TFunction, ThirdPartyModule, WithT, i18n } from 'i18next';
...
export interface TransProps<E extends Element = HTMLDivElement> extends React.HTMLProps<E>, Partial<WithT> {
...
export function useTranslation(ns?: Namespace, options?: UseTranslationOptions): UseTranslationResponse;
...
export function withTranslation(
  ...
  ResolvedProps = JSX.LibraryManagedAttributes<C, Subtract<React.ComponentProps<C>, WithTranslationProps>>,
>(
  component: C,
